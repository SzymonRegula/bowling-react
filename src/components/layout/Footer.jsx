    ...
    <footer className={classes.footer}>
      <Container>
        <div className={classes.container}>
          <div>
            <h2 className={classes.h2}>Bowling Alley</h2>
            <span className={classes.adress}>Gdańsk, Aleja Grunwaldzka</span>
          </div>

          <nav>
            <h2 className={classes.h2}>Quick Links</h2>
            <ul>
              <li className={classes.bowling}>
          ...
          <div>
            <ul>
              <li>
                <Link className={classes.link} to='tel:012345678'>
                  <span>tel.: 012 345 678</span>
                </Link>
              </li>
              <li>
                <Link className={classes.link} to='mailto:bowling@gmail.com'>
